    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<RegistroDefectoBolsa>(entity =>
            {
                ...
                entity.Ignore(e => e.RegistradoPor);
                entity.Ignore(e => e.Gravedad);
                entity.Ignore(e => e.ProveedorNotificado);
                entity.Ignore(e => e.FechaNotificacion);
            ...
            modelBuilder.Entity<LoteProduccion>(entity =>
            {
                ...
                entity.HasOne(e => e.Turno)
                      ...
                      .HasPrincipalKey(t => t.TurnoProduccionID)
                      .OnDelete(DeleteBehavior.Restrict);
            ...
            // ================================================================
            // ✅ ✅ ✅ NUEVAS CONFIGURACIONES - AGREGAR AQUÍ ✅ ✅ ✅
            // ================================================================

            // Configuración de ConfiguracionTurno
            modelBuilder.Entity<ConfiguracionTurno>(entity =>
            {
                entity.ToTable("ConfiguracionTurnos");
                entity.HasKey(e => e.ConfiguracionTurnoID);
                ...
                entity.Property(e => e.OverrideActivo)
                    .IsRequired()
                ...
                // Índice único para evitar duplicados (Turno + Fecha)
                entity.HasIndex(e => new { e.TurnoNumero, e.Fecha })
                    .IsUnique()
                    .HasDatabaseName("IX_ConfiguracionTurnos_TurnoFecha");
            });

            // Configuración de ProgramacionProduccion
            modelBuilder.Entity<ProgramacionProduccion>(entity =>
            {
                entity.ToTable("ProgramacionProduccion");
                entity.HasKey(e => e.ProgramacionProduccionID);
